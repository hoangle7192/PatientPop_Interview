...
public class GlobalConstants {
    ...
    public static final String STAGING = "https://compare-staging.patientpop.com/checkup";
    public static final String DEV = "TO-DO";
    public static final String TEST = "TO-DO";
